# Battery Install Station Monitoring

A Windows desktop application for monitoring battery installation operations on an industrial production line.

## Overview

This repository presents **ATMC.App.KMC.H5.BatteryInstall** as a public portfolio project. The production source code is intentionally not included because the application belongs to an industrial automation environment.

## Project Purpose

The application supports an operator station where battery installation results are checked, visual registration data is evaluated, and the final OK/NG decision is prepared for production records.

## Key Features

- Monitors the battery installation workflow
- Evaluates vision/registration results
- Displays OK/NG status for the operator
- Prepares structured result data for logs and database storage
