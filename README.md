# ATMC.App.KMC.H5.BatteryInstall

Battery installation jarayonini sanoat liniyasida nazorat qilish va natijalarni saqlash uchun Windows desktop ilovasi.

## Overview

This repository is a public portfolio page for the **BatteryInstall** project. The production source code is intentionally not included because the application belongs to an industrial automation environment.

## What the application does

Battery install stansiyasida robot/PLC signallari va vizual ro'yxatga olish natijalari asosida OK/NG qarorini shakllantiradi.

## Main features

- Ish jarayonini bosqichma-bosqich kuzatish
- Vision/registration natijalarini tekshirish
- OK/NG statusini operator panelida ko'rsatish
- Natijalarni lokal result papka va ma'lumotlar bazasi uchun tayyorlash
